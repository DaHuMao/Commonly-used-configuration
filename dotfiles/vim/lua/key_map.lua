...
local function lsp_keymaps()
  -- 跳转到声明
  keymap("n", "gd", "<cmd>Lspsaga Lspsaga peek_definition<CR>", opts)
  -- 跳转到定义
...
local function debug_keymaps()
  keymap("n", "<F9>", "<cmd>lua require'dap'.toggle_breakpoint(); require'plug_config.dap.dap-util'.store_breakpoints(true)<cr>", opts)
