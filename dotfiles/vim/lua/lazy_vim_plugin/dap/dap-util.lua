...
-- refresh config and continue debugging
M.reload_continue = function()
  -- Reload dap configuration
  package.loaded['lazy_vim_plugin.dap'] = nil
  require('lazy_vim_plugin.dap')
  dap.continue()
end

-- support passing args - parse string to argument table
...
-- Convert string to argument table, handling quotes
...
-- persist breakpoint
local bp_base_dir = home_dir .. "/.cache/dap-breakpoint/"
